...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-c2ow4sy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-c2ow4sy.containers.anotherwebservice.com/
...
```
git clone git@github.com:Fatalist0001/container-c2ow4sy.git
cd container-c2ow4sy
```
...
```
docker attach container-c2ow4sy
```
